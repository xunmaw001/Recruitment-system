...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 7% 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"0 4px 0 0","justifyContent":"center","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>薪资待遇</div>
        <el-input v-model="formSearch.xinzidaiyu" placeholder="薪资待遇" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 4px 0 0","justifyContent":"center","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>就业城市</div>
        <el-input v-model="formSearch.jiuyechengshi" placeholder="就业城市" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 4px 0 0","justifyContent":"center","display":"flex"}'>
	...
	<div class="list" :style='{"padding":"20px 7% 20px","margin":"20px 0 10px","background":"none"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0px","margin":"30px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"margin":"0 0 20px","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"23.5%","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"width":"100%","boxShadow":"0px 2px 6px #ccc","margin":"0 0 8px","objectFit":"cover","display":"block","height":"260px"}' v-if="item.bangonghuanjing && item.bangonghuanjing.substr(0,4)=='http'" :src="item.bangonghuanjing" class="image" />
				<img :style='{"width":"100%","boxShadow":"0px 2px 6px #ccc","margin":"0 0 8px","objectFit":"cover","display":"block","height":"260px"}' v-else :src="baseUrl + (item.bangonghuanjing?item.bangonghuanjing.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"4px 0px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis"}' class="name ">{{item.gangweimingcheng}}</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.jiuyechengshi != '') searchWhere.jiuyechengshi = '%' + this.formSearch.jiuyechengshi + '%';
