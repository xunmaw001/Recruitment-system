...
<div :style='{"width":"100%","padding":"20px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="企业地址" prop="qiyedizhi">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="企业图片" v-if="type!='cross'" prop="qiyetupian">
            <file-upload
            tip="点击上传企业图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' class="upload" v-else label="企业图片" prop="qiyetupian">
