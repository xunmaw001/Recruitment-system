	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.jianlitoudi" label="简历投递" prop="jianlitoudi">
					<file-upload
						tip="点击上传简历投递"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jianlitoudi" label="简历投递" prop="jianlitoudi">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"0","background":"#2EB1FD","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.jianlitoudi)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.jianlitoudi" label="简历投递" prop="jianlitoudi">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="应聘日期" prop="yingpinriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yingpinriqi" label="应聘日期" prop="yingpinriqi">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="应聘内容" prop="yingpinneirong">
					<editor 
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.yingpinneirong" label="应聘内容" prop="yingpinneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.yingpinneirong"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.yingpinneirong = this.ruleForm.yingpinneirong.replace(reg,'../../../springboot173lo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jianlitoudi!=null) {
		this.ruleForm.jianlitoudi = this.ruleForm.jianlitoudi.replace(new RegExp(this.$base.url,"g"),"");
	}
