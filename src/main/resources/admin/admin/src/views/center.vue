<template>
  <div>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='qiye'"  label="企业编号" prop="qiyebianhao">
          <el-input v-model="ruleForm.qiyebianhao" readonly              placeholder="企业编号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='qiye'"  label="企业名称" prop="qiyemingcheng">
          <el-input v-model="ruleForm.qiyemingcheng"               placeholder="企业名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='qiye'"  label="企业地址" prop="qiyedizhi">
          <el-input v-model="ruleForm.qiyedizhi"               placeholder="企业地址" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='qiye'"  label="联系人" prop="lianxiren">
          <el-input v-model="ruleForm.lianxiren"               placeholder="联系人" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='qiye'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-if="flag=='qiye'" label="企业图片" prop="qiyetupian">
          <file-upload
          tip="点击上传企业图片"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="用户名" prop="yonghuming">
        ...
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="手机" prop="shouji">
        ...
        <el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="求职意向" prop="qiuzhiyixiang">
          <el-input v-model="ruleForm.qiuzhiyixiang"               placeholder="求职意向" clearable></el-input>
        </el-form-item>
